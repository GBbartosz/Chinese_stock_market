...
if __name__ == '__main__':
    ...
    plotsandcharts.sector_bar_chart(sectors_l, sector_ps_ratio_dict, 'PS ratio', 'average')
    ...
    plotsandcharts.sector_bar_chart(sectors_l, sector_pb_ratio, 'Price to book ratio', 'average')
