...
if __name__ == '__main__':
    ...
    for company in companys_dictionary.keys():
        ...
        if verified_data_result is None:
            ...
            dfs, first_date_by_sector_collection_dic rg wdcq, first_date_by_company_dic, late_first_sector_all, late_first_sector_doc, late_first_sector_price, price_docs_date_not_compatible_sector_dict, doc_dates_not_equal_dict, late_first_sector_price_companies = verified_data_result
    ...
    dicts_l = [sector_capitalization_dict, sector_capitalization_change_dict, sector_pe_ratio_dict, sector_ps_ratio_dict, sector_revenue_dict, sector_revenue_change_dict, sector_net_income_dict, sector_net_income_change_dict, sector_pb_ratio, sector_price, sector_price_change]
    res_sectors_dicts = f.create_dictionaries_of_sectors_with_lists(sectors_l, dicts_l)
    sector_capitalization_dict, sector_capitalization_change_dict, sector_pe_ratio_dict, sector_ps_ratio_dict, sector_revenue_dict, sector_revenue_change_dict, sector_net_income_dict, sector_net_income_change_dict, sector_pb_ratio, sector_price, sector_price_change = res_sectors_dicts
